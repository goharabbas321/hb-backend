...
@section('page-script')
    ...
    <script>
        window.BulkURL = "{{ route('hospitals.bulk_action') }}";
...
@section('content')
    @can('statics_hospitals')
        @include('medical::hospitals.partials.hospitals_statics')
    @endcan

    <div class="row">
        <!-- Filter Card (Initially Hidden) -->
        <div id="filter-card" class="col-3 hidden">
            @include('medical::hospitals.partials.hospitals_search_filter')
        </div>
        <!-- DataTable Card -->
        <div id="datatable-card" class="col-12 card">
            @include('medical::hospitals.partials.hospitals_nav')
                ...
                <table class="table gms-table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('medical::messages.hospitals.table.name_en') }}</th>
                            <th>{{ __('medical::messages.hospitals.table.name_ar') }}</th>
                            <th>{{ __('medical::messages.hospitals.table.city') }}</th>
                            <th>{{ __('medical::messages.hospitals.table.email') }}</th>
                            <th>{{ __('medical::messages.hospitals.table.contact') }}</th>
    ...
    @include('medical::hospitals.partials.hospital_create')
...
@push('script-page')
    @php
        ...
        $button = [
            'name' => __('medical::messages.hospitals.button.create_hospital'),
    ...
    @include('layouts.sections.datatable', [
        ...
        'restore_permission' => 'restore_hospitals',
