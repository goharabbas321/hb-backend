...
<!-- Page Scripts -->
@section('page-script')
    @vite(['Modules/Medical/resources/assets/js/cities.js'])
    <script>
        window.BulkURL = "{{ route('cities.bulk_action') }}";
...
@section('content')
    @can('statics_cities')
        @include('medical::cities.partials.cities_statics')
    @endcan

    <div class="row">
        <!-- Filter Card (Initially Hidden) -->
        <div id="filter-card" class="col-3 hidden">
            @include('medical::cities.partials.cities_search_filter')
        </div>
        <!-- DataTable Card -->
        <div id="datatable-card" class="col-12 card">
            @include('medical::cities.partials.cities_nav')
                ...
                <table class="table gms-table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('medical::messages.cities.table.name_en') }}</th>
                            <th>{{ __('medical::messages.cities.table.name_ar') }}</th>
    ...
    @include('medical::cities.partials.city_create')
...
@push('script-page')
    @php
        ...
        $button = [
            'name' => __('medical::messages.cities.button.create_city'),
    ...
    @include('layouts.sections.datatable', [
        ...
        'restore_permission' => 'restore_cities',
