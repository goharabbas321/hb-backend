...
<div class="offcanvas offcanvas-end" id="add-new-record">
    <div class="offcanvas-header border-bottom">
        <h5 class="offcanvas-title" id="exampleModalLabel">{{ __('medical::messages.facilities.heading.create') }}</h5>
    ...
    <div class="offcanvas-body flex-grow-1">
        <!-- Add facility form -->
        <form id="facility_form" class="row g-3" method="POST" action="{{ route('facilities.store') }}">
            @csrf
            <div class="col-md-6">
