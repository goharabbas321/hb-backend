...
@section('page-script')
    ...
    <script>
        window.BulkURL = "{{ route('doctors.bulk_action') }}";
...
@section('content')
    @can('statics_doctors')
        @include('medical::doctors.partials.doctors_statics')
    @endcan

    <div class="row">
        <!-- Filter Card (Initially Hidden) -->
        <div id="filter-card" class="col-3 hidden">
            @include('medical::doctors.partials.doctors_search_filter')
        </div>
        <!-- DataTable Card -->
        <div id="datatable-card" class="col-12 card">
            @include('medical::doctors.partials.doctors_nav')
                ...
                <table class="table gms-table">
                    <thead>
                        <tr>
                            ...
                            <th>{{ __('medical::messages.doctors.table.name_en') }}</th>
                            <th>{{ __('medical::messages.doctors.table.name_ar') }}</th>
                            <th>{{ __('medical::messages.doctors.table.hospital') }}</th>
                            <th>{{ __('medical::messages.doctors.table.specialization') }}</th>
    ...
    @include('medical::doctors.partials.doctor_create')
...
@push('script-page')
    @php
        ...
        $button = [
            'name' => __('medical::messages.doctors.button.create_doctor'),
    ...
    @include('layouts.sections.datatable', [
        ...
        'restore_permission' => 'restore_doctors',
