...
document.addEventListener('DOMContentLoaded', function (e) {
    (function () {
        ...
        if (city_form) {
            const fv = FormValidation.formValidation(city_form, {
                fields: {
                    name_en: {
                        validators: {
                            notEmpty: {
                                message: __('cities.validation.name_en_empty')
                            },
                            stringLength: {
                                min: 3,
                                max: 255,
                                message: __('cities.validation.name_en_length')
                            }
                        }
                    },
                    name_ar: {
                        validators: {
                            notEmpty: {
                                message: __('cities.validation.name_ar_empty')
                            },
                            stringLength: {
                                min: 3,
                                max: 255,
                                message: __('cities.validation.name_ar_length')
                            }
                        }
                    }
                },
                    ...
                    instance.on('core.form.valid', function () {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                document.getElementById('city_form').submit();
                            }
                        });
                    });
                }
