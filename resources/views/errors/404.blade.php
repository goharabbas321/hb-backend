...
@section('title', ($current_language == 'ar') ? 'الصفحة مو موجودة️' : 'Page Not Found')
...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    <h1 class="mx-2 mb-2 fs-xxlarge" style="line-height: 6rem;font-size: 6rem;">404</h1>
    <h4 class="mx-2 mb-2">{{ __('messages.error.404.heading') }} ⚠️</h4>
    <p class="mx-2 mb-6">{{ __('messages.error.404.sub_heading') }}</p>
    <a href="{{url('/')}}" class="mb-10 btn btn-primary">{{ __('messages.error.404.btn_home') }}</a>
    <div class="mt-4">
