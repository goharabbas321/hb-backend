...
<div class="container-xxl container-p-y">
  <div class="misc-wrapper">
    ...
    <h4 class="mx-2 mb-2">{{ __('messages.error.401.heading') }} 🔐</h4>
    <p class="mx-2 mb-6">{{ __('messages.error.401.sub_heading') }}</p>
    <a href="{{url('/')}}" class="btn btn-primary">{{ __('messages.error.401.btn_home') }}</a>
    <div class="mt-12">
