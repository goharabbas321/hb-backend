...
@section('title', 'Privacy Policy - Front Pages')
        ...
        <section id="landingFAQ" class="section-py bg-body landing-faq">
            <div class="container">
                <div class="mb-4 text-center">
                    <span class="badge bg-label-primary">Privacy Policy</span>
                </div>
                <h4 class="mb-1 text-center">Privacy
                    <span class="position-relative fw-extrabold z-1">Policy
                ...
                <p class="mb-12 text-center pb-md-4">Here are the privacy policy of the system
                </p>
